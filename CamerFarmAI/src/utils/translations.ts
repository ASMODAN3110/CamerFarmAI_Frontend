...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    'plantations.createModal.next': 'Jókó',
    ...
    'plantations.detail.monitoring': 'Nsámbí',
    ...
    'profile.idLabel': 'ID Meká',
    'profile.idHint': 'Meká unique',
  ...
  ew: {
    ...
    'login.errors.twoFactorTokenMissing': 'Kóde nsámbí alé',
    'login.errors.twoFactorFailed': 'Kóde 2FA alé mán. Bwá sígní.',
    'login.twoFactorTitle': 'Nsámbí mbálá míbalé',
    'login.twoFactorDescription': 'Sígní kóde mbálá 6 wá app nsámbí',
    'login.twoFactorCodeLabel': 'Kóde nsámbí',
    'login.twoFactorCodePlaceholder': '000000',
    'login.verifyButton': 'Nsámbí',
    'login.verifying': 'Nsámbí...',
    'login.backToLogin': 'Bwá kómbí',
    'login.motivational.line1': 'Bwá bisó wá, bwá mán',
    'login.motivational.line2': 'meká wá é bwá bisó wá',
    'login.motivational.line3': 'Bisó jókón é bwá mán ékpé mbálá',
    'signup.title': 'SÍGNÍ',
    ...
    'signup.confirmPasswordLabel': 'Nsámbí mótí',
    'signup.confirmPasswordPlaceholder': 'Sígní mótí wá mbálá',
    ...
    'signup.errors.passwordNumber': 'Mótí ékpé mbálá míbalé meká',
    'signup.errors.passwordSpecial': 'Mótí ékpé mbálá míbalé meká (!@#$%^&*(),.?":{}|<>)',
    'signup.errors.confirmPasswordRequired': 'Nsámbí mótí ékpé',
    'signup.errors.passwordsMismatch': 'Mótí alé mán',
    'signup.errors.signupFailed': 'Sígní alé mán. Bwá sígní.',
    'notifications.title': 'Nsámbí',
    'notifications.empty': 'Alé nsámbí',
    'notifications.loading': 'Nsámbí...',
    'notifications.noDescription': 'Nsámbí',
    'notifications.sent': 'sígní',
    'notifications.noEmail': 'Alé nsámbí email',
    'notifications.justNow': 'Mbálá',
    'notifications.minutesAgo': 'min',
    'notifications.hoursAgo': 'h',
    'notifications.daysAgo': 'j',
    'notifications.delete': 'Sóbí',
    'hero.heading': 'Bisó jókón <span class="hero__highlight">bisó mán</span>, <span class="hero__highlight">jókón</span> é <span class="hero__highlight">bwá mán</span>',
    'features.automation.title': 'Bwá mán',
    'features.automation.description': 'Bwá nsámbí mán, nsámbí mvú é nsámbí alé effort. Meká wá, alimenté par mán mán, garantit ko meká ékpé s\'exécutent même en cas de meká de mán.',
    'features.ai.title': 'AI Intégré',
    'features.ai.description': 'Identifiez meká meká par simple meká é recevez meká meká immédiates. Accédez à meká meká personnalisés en faransinkoore, inngilinkoore é meká locales.',
    'features.realtime.title': 'Nsámbí temps réel',
    'features.realtime.description': 'Fón meká mán meká wá à meká: mvú bisó, mvú, CO2 é niveau mán. Recevez meká temps réel pour anticiper meká mán é anomalies.',
    'benefits.yield.title': 'Bwá meká produits',
    'benefits.energy.title': 'Sóbí meká mán',
    'benefits.water.title': 'Économiser meká mán',
    'intelligent.title': 'Bisó mán face climat, basée meká',
    'intelligent.description': 'En utilisant meká temps réel comme coup pouce meká, meká é meká fusionnent monde physique avec outils numériques pour lutter contre meká quotidiens é améliorer meká.',
    'cta.title': 'Prêt à transformer bisó wá?',
    'cta.subtitle': 'Rejoignez meká d\'meká qui augmentent meká avec CamerFarm AI',
    'cta.button': 'Nsámbí Wá',
    'footer.description': 'Meká mán pour bisó camerounaise moderne é durable.',
    'footer.resources.title': 'Meká',
    'footer.resources.documentation': 'Meká',
    'footer.resources.guide': 'Meká meká',
    'footer.legal.title': 'Meká',
    'footer.legal.privacy': 'Meká',
    'footer.legal.terms': 'Meká',
    'footer.legal.cookies': 'Cookies',
    'footer.social.title': 'Bwá Wá',
    'footer.copyright': '© 2025 CamerFarm AI. Tous Droits Réservés.',
    'floatingButton.ariaLabel': 'Nsámbí support',
    'plantations.loading': 'Nsámbí bisó...',
    'plantations.list.title': 'Bisó Wá',
    'plantations.create': 'Sígní bisó',
    'plantations.area': 'Nkómbó',
    'plantations.viewDetails': 'Fón meká',
    'plantations.empty.title': 'OUPS,',
    'plantations.empty.message': 'Wá alé sígní bisó.',
    'plantations.empty.action': 'Sígní bisó',
    'plantations.empty.icon': 'Alé bisó',
    'plantations.slogan.line1': 'Bwá bisó wá, bwá mán meká wá é bwá bisó wá',
    'plantations.slogan.line2': 'Bisó jókón é bwá mán ékpé mbálá',
    'graphs.title': 'DASHBOARD',
    'graphs.welcome.title': 'Bwá meká CamerFarm AI wá.',
    'graphs.welcome.description': 'Fón temps réel meká nsámbí wá pour mieux comprendre meká bisó wá é optimiser meká wá.',
    'graphs.welcome.hint': 'Utilisez meká ci-dessous pour filtrer meká nsámbí (Mvú, mvú, CO₂, etc.)',
    'graphs.sensors.humidity': 'Nsámbí Mvú',
    'graphs.sensors.temperature': 'Nsámbí Mvú',
    'graphs.sensors.soilMoisture': 'Nsámbí Mvú bisó',
    'graphs.sensors.luminosity': 'Nsámbí Nsámbí',
    'graphs.sensors.co2': 'Nsámbí CO2',
    'graphs.sensors.waterLevel': 'Niveau mán',
    'graphs.dateFrom': 'Du',
    'graphs.dateTo': 'Au',
    'graphs.applyFilter': 'Appliquer Filtre',
    'graphs.resetFilter': 'Réinitialiser',
    'graphs.chart.title': 'Évolution',
    'graphs.loading': 'Nsámbí meká nsámbí...',
    'graphs.empty': 'Alé meká nsámbí disponible meká ékpé.',
    'monitoring.sensors.title': 'Meká nsámbí temps réel',
    'monitoring.sensors.temperature': 'Mvú',
    'monitoring.sensors.soilHumidity': 'Mvú bisó',
    'monitoring.sensors.co2': 'Meká CO2',
    'monitoring.sensors.luminosity': 'Nsámbí',
    'monitoring.sensors.waterLevel': 'Niveau mán',
    'monitoring.thresholds.title': 'Meká nsámbí',
    'monitoring.thresholds.subtitle': 'Ajustez meká nsámbí wá pour recevoir alertes mán.',
    'monitoring.thresholds.min': 'Meká min',
    'monitoring.thresholds.max': 'Meká max',
    'monitoring.thresholds.edit': 'Bwá meká',
    'monitoring.thresholds.save': 'Nsámbí',
    'monitoring.thresholds.saving': 'Nsámbí...',
    'monitoring.thresholds.cancel': 'Bwá',
    'monitoring.thresholds.editingFor': 'Bwá meká pour',
    'monitoring.thresholds.editingSubtitle': 'Définissez meká minimales é maximales pour déclencher alertes.',
    'monitoring.thresholds.invalidData': 'Meká meká alé mán',
    'monitoring.thresholds.maxMustBeGreater': 'Meká maximum ékpé strictement supérieur meká minimum',
    'monitoring.thresholds.updateSuccess': 'Meká bwá mán',
    'monitoring.thresholds.updateError': 'Alé mán bwá meká',
    'monitoring.thresholds.notFound': 'Nsámbí ou bisó alé mán',
    'monitoring.thresholds.forbidden': 'Wá alé meká bwá meká ékpé',
    'monitoring.thresholds.unauthorized': 'Wá ékpé kómbí bwá meká',
    'monitoring.updated': 'Bwá',
    'monitoring.status.good': 'Bon',
    'monitoring.status.optimal': 'Optimal',
    'monitoring.status.moderate': 'Modéré',
    'monitoring.status.low': 'Faible',
    ...
    'monitoring.status.normal': 'Normal',
    'monitoring.status.dim': 'Sombre',
    'monitoring.equipment.title': 'Bwá meká é meká',
    'monitoring.equipment.irrigationPump': 'Meká nsámbí mán',
    'monitoring.equipment.fans': 'Meká',
    'monitoring.equipment.lighting': 'Nsámbí',
    'monitoring.equipment.offline': 'Alé jókón',
    'monitoring.equipment.noActuators': 'Alé meká actuellement installé champ ékpé.',
    'monitoring.equipment.updateError': 'Alé mán bwá meká. Bwá sígní.',
    'monitoring.mode.automatic': 'Bwá mán',
    'monitoring.mode.manual': 'Meká',
    'monitoring.mode.automaticInfo': 'Meká bwá mán activé: Meká contrôlés automatiquement selon meká nsámbí.',
    'monitoring.mode.updateError': 'Alé mán bwá meká. Bwá sígní.',
    'monitoring.noSensors': 'Alé nsámbí actuellement affecté bisó ékpé. Bwá affecter nsámbí voir meká monitoring.',
    'monitoring.help.title': 'Comment fonctionnent couleurs jauges?',
    'monitoring.help.intro': 'Couleurs jauges s\'adaptent automatiquement selon meká wá configurés (mekáMin é mekáMax). Chaque jauge utilise meká couleurs indiquer rapidement meká nsámbí wá.',
    'monitoring.help.temperature.title': '🌡️ Mvú (0-50°C)',
    'monitoring.help.temperature.description': 'Jauge mvú affiche vert autour meká minimum (mvú mán), puis transitionne progressivement vers jaune é orange entre meká, é devient rouge au-dessus meká maximum (mán).',
    'monitoring.help.soilHumidity.title': '💧 Mvú bisó (0-100%)',
    'monitoring.help.soilHumidity.description': 'Meká mán (verte) situe entre meká minimum é maximum. En dessous meká min ou au-dessus meká max, couleur passe orange puis rouge indiquer niveau mán.',
    'monitoring.help.co2.title': '🌬️ Meká CO2 (0-2500 ppm)',
    'monitoring.help.co2.description': 'Vert indique mán niveau CO2 (en dessous meká min). Couleur transitionne vers jaune puis orange entre meká, é devient rouge au-dessus meká maximum (niveau mán).',
    'monitoring.help.luminosity.title': '☀️ Nsámbí (0-100000 lux)',
    'monitoring.help.luminosity.description': 'Meká mán (verte) trouve entre meká minimum é maximum. En dehors plage ékpé, couleur devient jaune (meká) puis rouge (saturation ou obscurité extrême).',
    'monitoring.help.waterLevel.title': '💧 Niveau mán (0-100%)',
    'monitoring.help.waterLevel.description': 'Rouge indique niveau mán (en dessous meká min). Au-dessus meká minimum, couleur passe progressivement orange, puis vert indiquer niveau mán.',
    'monitoring.help.zones.optimal': 'Meká mán',
    'monitoring.help.zones.warning': 'Meká mán',
    'monitoring.help.zones.danger': 'Meká mán',
    'monitoring.help.close': 'Bwá',
    'plantations.createModal.title': 'Sígní meká meká',
    'plantations.createModal.nameLabel': 'Nkómbó bisó wá',
    'plantations.createModal.namePlaceholder': 'Sígní nkómbó bisó wá',
    'plantations.createModal.areaLabel': 'Nkómbó bisó',
    'plantations.createModal.areaPlaceholder': 'Sígní nkómbó bisó wá',
    'plantations.createModal.areaUnit.m2': 'm²',
    'plantations.createModal.areaUnit.ha': 'ha',
    'plantations.createModal.areaUnit.acre': 'acre',
    'plantations.createModal.areaUnit.km2': 'km²',
    'plantations.createModal.locationLabel': 'Nkómbó',
    'plantations.createModal.locationPlaceholder': 'Sígní meká bisó wá',
    'plantations.createModal.next': 'Jókó',
    'plantations.createModal.cancel': 'Bwá',
    'plantations.createModal.submitting': 'Sígní...',
    'plantations.createModal.cropTypeLabel': 'Meká bisó',
    'plantations.createModal.cropTypePlaceholder': 'Ex: Manioc, cacao...',
    'plantations.createModal.latitudeLabel': 'Latitude',
    ...
    'plantations.createModal.errors.areaInvalid': 'Nkómbó ékpé meká mán',
    'plantations.createModal.errors.locationRequired': 'Nkómbó ékpé',
    ...
    'plantations.createModal.errors.coordinatesRequiredTogether': 'Latitude é longitude ékpé meká meká',
    'plantations.cropType': 'Bisó',
    'plantations.errors.fetchFailed': 'Alé bwá bisó. Meká affichées peuvent alé mán.',
    'plantations.detail.title': 'Meká bisó',
    'plantations.detail.loading': 'Nsámbí bisó...',
    'plantations.detail.backToList': 'Bwá meká',
    'plantations.detail.createdAt': 'Sígní',
    'plantations.detail.monitoring': 'Nsámbí',
    'plantations.detail.graphs': 'Meká',
    'plantations.detail.sensors.title': 'Nsámbí',
    'plantations.detail.sensors.active': 'Mán',
    'plantations.detail.sensors.inactive': 'Alé mán',
    ...
    'plantations.detail.sensors.co2Level': 'Niveau CO₂',
    'plantations.detail.sensors.waterLevel': 'Niveau mán',
    'plantations.detail.sensors.luminosity': 'Nsámbí',
    'plantations.detail.sensors.lastUpdate': 'Meká bwá',
    'plantations.detail.sensors.noSensors': 'Alé nsámbí mán',
    'plantations.detail.sensors.noData': 'Alé meká',
    'plantations.detail.sensors.noSensorsMessage': 'Bisó ékpé alé nsámbí mán. Bwá nsámbí bwá nsámbí.',
    'plantations.detail.errors.invalidId': 'ID bisó alé mán',
    'plantations.detail.errors.fetchFailed': 'Alé bwá meká bisó.',
    'plantations.detail.errors.notFound': 'Bisó alé mán',
    'profile.back': 'Bwá',
    'profile.pageLabel': 'Nsámbí meká',
    'profile.welcome': 'Bwá, {name}',
    'profile.loading': 'Nsámbí nsámbí...',
    'profile.loadingHint': 'Si nsámbí prend trop temps, meká meká alé mán.',
    'profile.changePhoto': 'Bwá',
    'profile.noPhone': 'Alé téléfón',
    'profile.roleLabel': 'Meká',
    'profile.editButton': 'Bwá',
    'profile.saveButton': 'Nsámbí',
    'profile.saving': 'Nsámbí...',
    'profile.cancelButton': 'Bwá',
    ...
    'profile.languageLabel': 'Meká',
    'profile.emailLabel': 'Email wá',
    'profile.noEmail': 'Alé email',
    'profile.notConfigured': 'Alé meká',
    'profile.addEmail': 'Sígní email',
    'profile.roleHint': 'Meká alé bwá',
    'profile.phoneLabel': 'Téléfón',
    'profile.phonePlaceholder': 'Téléfón wá',
    'profile.idLabel': 'ID Meká',
    'profile.idHint': 'Meká unique',
    'profile.twoFactor.title': 'Nsámbí mbálá míbalé',
    'profile.twoFactor.description': 'Meká kóntó wá code nsámbí meká',
    'profile.twoFactor.enabled': 'Mán',
    'profile.twoFactor.disabled': 'Alé mán',
    'profile.twoFactor.enableButton': 'Bwá 2FA',
    'profile.twoFactor.disableButton': 'Bwá 2FA',
    'profile.twoFactor.setupTitle': 'Meká 2FA',
    'profile.twoFactor.setupDescription': 'Fón QR kóde app nsámbí wá (Google Authenticator, Authy, etc.)',
    'profile.twoFactor.scanQRCode': 'Fón QR kóde ékpé',
    'profile.twoFactor.enterCode': 'Sígní code nsámbí',
    'profile.twoFactor.codeLabel': 'Code nsámbí',
    'profile.twoFactor.codePlaceholder': '000000',
    'profile.twoFactor.activateButton': 'Bwá',
    'profile.twoFactor.deactivateButton': 'Bwá',
    'profile.twoFactor.disableTitle': 'Bwá 2FA',
    'profile.twoFactor.disableDescription': 'Sígní code 2FA wá meká bwá',
    'profile.twoFactor.success': '2FA bwá mán',
    'profile.twoFactor.error': 'Alé mán bwá 2FA',
    'profile.errors.firstNameRequired': 'Nkómbó ndé ékpé',
    'profile.errors.lastNameRequired': 'Nkómbó ékpé',
    'profile.errors.phoneRequired': 'Téléfón ékpé',
    'profile.errors.phoneInvalid': 'Téléfón alé mán',
    'profile.errors.invalidImage': 'Bwá bwá meká mán',
    'profile.errors.imageSizeExceeded': 'Meká alé mán 5MB',
    'profile.errors.uploadFailed': 'Alé mán upload meká',
    'profile.errors.updateFailed': 'Alé mán bwá nsámbí',
    'profile.role.farmer': 'Agriculteur',
    'profile.role.admin': 'Administrateur',
    'profile.role.technician': 'Technicien',
    'admin.fakers.title': 'Bwá meká nsámbí',
    'admin.fakers.subtitle': 'Bwá meká meká nsámbí application',
    'admin.fakers.test.title': 'Nsámbí fakers',
    'admin.fakers.test.description': 'Nsámbí fakers alé bwá meká meká',
    'admin.fakers.test.button': 'Nsámbí fakers',
    'admin.fakers.test.testing': 'Nsámbí meká...',
    'admin.fakers.testError': 'Alé mán nsámbí fakers',
    'admin.fakers.generate.title': 'Bwá fakers',
    'admin.fakers.generate.description': 'Bwá é bwá meká meká meká meká',
    'admin.fakers.generate.countLabel': 'Meká meká',
    'admin.fakers.generate.countPlaceholder': '100',
    'admin.fakers.generate.scenarioLabel': 'Meká',
    'admin.fakers.generate.entityLabel': 'Meká meká',
    'admin.fakers.generate.entityOptional': 'meká',
    'admin.fakers.generate.entityAll': 'Meká meká',
    'admin.fakers.generate.button': 'Bwá',
    'admin.fakers.generate.generating': 'Bwá meká...',
    'admin.fakers.generateError': 'Alé mán bwá fakers',
    'admin.fakers.errors.countInvalid': 'Meká ékpé mán 0',
    'admin.fakers.errors.scenarioRequired': 'Bwá bwá meká',
    'admin.fakers.results.total': 'Meká',
    'admin.fakers.results.users': 'Meká',
    'admin.fakers.results.plantations': 'Bisó',
    'admin.fakers.results.sensors': 'Nsámbí',
    'admin.fakers.results.sensorReadings': 'Meká nsámbí',
    'admin.fakers.results.actuators': 'Meká',
    'admin.fakers.results.events': 'Meká',
    'admin.fakers.results.notifications': 'Nsámbí',
    'admin.fakers.scenarios.normal': 'Mán - Meká plages mán',
    'admin.fakers.scenarios.edge': 'Edge Cases - Meká meká',
    'admin.fakers.scenarios.alert': 'Meká - Meká dépassant meká',
    'admin.fakers.scenarios.seasonal': 'Meká - Meká meká',
    'admin.fakers.scenarios.mixed': 'Meká - Meká meká',
    'admin.fakers.scenarios.normal.description': 'Bwá meká plages mán nsámbí. Mán nsámbí meká standard application.',
    'admin.fakers.scenarios.edge.description': 'Bwá meká meká min/max. Mán nsámbí cas meká é meká.',
    'admin.fakers.scenarios.alert.description': 'Bwá meká dépassant meká meká meká. Mán nsámbí meká nsámbí.',
    'admin.fakers.scenarios.seasonal.description': 'Bwá meká 4 meká meká Cameroun: meká alé mvú, meká mvú, harmattan é bwá.',
    'admin.fakers.scenarios.mixed.description': 'Meká meká meká meká. Mán meká meká é meká.',
    'admin.fakers.scenarios.weights.normal': 'Meká mán',
    'admin.fakers.scenarios.weights.edge': 'Meká edge',
    'admin.fakers.scenarios.weights.alert': 'Meká alert',
    'admin.fakers.scenarios.weights.seasonal': 'Meká meká',
    'admin.fakers.info.title': 'Meká mán',
    'admin.fakers.info.description': 'Meká meká bwá mán',
    'admin.fakers.distribution.title': 'Meká défaut',
    'admin.fakers.distribution.description': 'Meká meká bwá 1000 fakers',
    'admin.fakers.distribution.percentage': 'Meká',
    'admin.fakers.entities.title': 'Meká meká mán',
    'admin.fakers.entities.description': 'Meká meká meká bwá',
    'admin.fakers.entities.user': 'Meká meká (meká, meká, admin)',
    'admin.fakers.entities.plantation': 'Bisó bisó camerounaises é meká meká',
    'admin.fakers.entities.sensor': 'Nsámbí (mvú, mvú bisó, CO2, niveau mán, nsámbí)',
    'admin.fakers.entities.sensorReading': 'Meká nsámbí meká meká mán',
    'admin.fakers.entities.actuator': 'Meká (meká, meká, meká, meká, meká, nsámbí)',
    'admin.fakers.entities.event': 'Meká (meká meká, meká mán/alé mán, meká meká)',
    'admin.fakers.entities.notification': 'Nsámbí (web, email, WhatsApp) meká',
    'admin.fakers.seasonal.title': 'Meká meká',
    'admin.fakers.seasonal.description': 'Meká nsámbí varient meká camerounaises',
    'admin.fakers.seasonal.dry_season': 'Meká alé mvú',
    'admin.fakers.seasonal.rainy_season': 'Meká mvú',
    'admin.fakers.seasonal.harmattan': 'Harmattan',
    'admin.fakers.seasonal.transition': 'Transition',
    'admin.fakers.results.percentage': '%',
    'admin.fakers.results.barChart': 'Répartition visuelle',
