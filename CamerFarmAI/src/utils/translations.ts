...
export const translations: Record<Language, Record<TranslationKey, string>> = {
  fr: {
    ...
    'docs.api.description': 'Les données brutes des capteurs sont accessibles via l\'API pour les besoins d\'analyse avancée. Consultez la documentation API Swagger pour plus de détails sur les endpoints /plantations/:id/sensors.',
  ...
  en: {
    ...
    'docs.api.description': 'Raw sensor data is accessible via API for advanced analysis needs. Consult Swagger API documentation for details on /plantations/:id/sensors endpoints.',
